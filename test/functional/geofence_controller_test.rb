...
class GeofenceControllerTest < ActionController::TestCase
  ...
  def test_edit
    ...
    assert_redirected_to :controller => "geofence/index" # For some reason separating index into an :action parameter causes this to fail...investigate later
  end
